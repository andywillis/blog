(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(t){if(t.ep)return;t.ep=!0;const o=n(t);fetch(t.href,o)}})();const p="_blockquote_uhtwo_1",u={blockquote:p};function g(e){return`
		<p class=${u.blockquote}>
			${e}
		</p>
	`}const y="_heading_1gru9_1",w="_h1_1gru9_7 _heading_1gru9_1",f="_h2_1gru9_13 _heading_1gru9_1",b="_h3_1gru9_22 _heading_1gru9_1",k="_date_1gru9_29 _h3_1gru9_22 _heading_1gru9_1",v={heading:y,h1:w,h2:f,h3:b,date:k};function d(e){const{link:a,level:n,type:i=e.level,text:t}=e;return`
		<${n}
			class="${v[i]}"
			${a?`id="${a}"`:""}
		>${t}
		</${n}>
	`}const S="_imageContainer_4n2l8_1",I="_image_4n2l8_1",x="_fadeIn_4n2l8_1",h={imageContainer:S,image:I,fadeIn:x};function _({src:e,alt:a}){return`
	...
	`}const T="_listitem_138vm_1",P={listitem:T};function l(e){return`<li class="${P.listitem}">${e.html}</li>`}function C({variant:e,items:a}){return e==="unordered"?`
			<ul>
				${a.map(n=>l(n)).join("")}
			</ul>
		`:`
	...
	`}const $="_paragraph_1axdu_1",R={paragraph:$};function B(e){return`
		<p class="${R.paragraph}">
			${e}
		</p>
	`}const D="_table_1woq6_1",z={table:D};function A(e){return`
		<table class="${z.table}">
			${e}
		</table>
	`}function M(e){switch(e.type){case"h3":return d({level:"h3",type:"h3",text:e.text});case"blockquote":return g(e.html);case"image":return _({src:e.src,alt:e.alt});case"table":return A(e.html);case"list":return C({variant:e.variant,items:e.items});default:return B(e.html)}}function L(e){return`${M(e)}`}const q="_content_101gy_1",J={content:q};function N(e){return`
		<div class="${J.content}">
			${e.map(L).join("")}
		</div>
	`}const j="_tag_ddfu1_1",F={tag:j};function H(e,a,n){return`
		<li class="${F.tag}">
			${e.tag}${a<n.length-1?",":""}
		</li>
	`}const O="_tagContainer_1q54i_1",G="_tags_1q54i_5",c={tagContainer:O,tags:G};function E(e){return`
		<section class=${c.tagContainer}>
			${d({level:"h3",type:"h3",text:"Tags"})}
			<ul class="${c.tags}">
				${e.map(H).join("")}
			</ul>
		</section>
	`}const W="_header_sufgh_1",V="_entry_sufgh_7",m={header:W,entry:V};function U(e,a){const{date:n,title:i,link:t,body:o,tags:r}=e;return`
		<section class="${m.entry}" data-type="entry">
			<header class="${m.header}">
				<a href="#${t}">
					${d({link:t,level:"h2",type:"h2",text:i})}
				</a>
				${d({level:"h3",type:"date",text:n})}
			</header>
			${N(o)}
			${E(r)}
		</section>
	`}const X="_entries_1i9hr_1",K={entries:X};function Y(e){return`
		<main class="${K.entries}">
			${e.map(U).join("")}
		</main>
	`}const Q="_footer_qr5sd_1",Z="_socialsList_qr5sd_12",ee="_icon_qr5sd_21",s={footer:Q,socialsList:Z,icon:ee};function te(){return`
		<footer class="${s.footer}">
			<section class="${s.socialsList}">
				<ul>
					<li>
						<a href="https://github.com/andywillis">
							<svg class="${s.icon}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" width="22" height="22"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M165.9 397.4c0 2-2.3 3.6-5.2 3.6-3.3.3-5.6-1.3-5.6-3.6 0-2 2.3-3.6 5.2-3.6 3-.3 5.6 1.3 5.6 3.6zm-31.1-4.5c-.7 2 1.3 4.3 4.3 4.9 2.6 1 5.6 0 6.2-2s-1.3-4.3-4.3-5.2c-2.6-.7-5.5.3-6.2 2.3zm44.2-1.7c-2.9.7-4.9 2.6-4.6 4.9.3 2 2.9 3.3 5.9 2.6 2.9-.7 4.9-2.6 4.6-4.6-.3-1.9-3-3.2-5.9-2.9zM244.8 8C106.1 8 0 113.3 0 252c0 110.9 69.8 205.8 169.5 239.2 12.8 2.3 17.3-5.6 17.3-12.1 0-6.2-.3-40.4-.3-61.4 0 0-70 15-84.7-29.8 0 0-11.4-29.1-27.8-36.6 0 0-22.9-15.7 1.6-15.4 0 0 24.9 2 38.6 25.8 21.9 38.6 58.6 27.5 72.9 20.9 2.3-16 8.8-27.1 16-33.7-55.9-6.2-112.3-14.3-112.3-110.5 0-27.5 7.6-41.3 23.6-58.9-2.6-6.5-11.1-33.3 2.6-67.9 20.9-6.5 69 27 69 27 20-5.6 41.5-8.5 62.8-8.5s42.8 2.9 62.8 8.5c0 0 48.1-33.6 69-27 13.7 34.7 5.2 61.4 2.6 67.9 16 17.7 25.8 31.5 25.8 58.9 0 96.5-58.9 104.2-114.8 110.5 9.2 7.9 17 22.9 17 46.4 0 33.7-.3 75.4-.3 83.6 0 6.5 4.6 14.4 17.3 12.1C428.2 457.8 496 362.9 496 252 496 113.3 383.5 8 244.8 8zM97.2 352.9c-1.3 1-1 3.3.7 5.2 1.6 1.6 3.9 2.3 5.2 1 1.3-1 1-3.3-.7-5.2-1.6-1.6-3.9-2.3-5.2-1zm-10.8-8.1c-.7 1.3.3 2.9 2.3 3.9 1.6 1 3.6.7 4.3-.7.7-1.3-.3-2.9-2.3-3.9-2-.6-3.6-.3-4.3.7zm32.4 35.6c-1.6 1.3-1 4.3 1.3 6.2 2.3 2.3 5.2 2.6 6.5 1 1.3-1.3.7-4.3-1.3-6.2-2.2-2.3-5.2-2.6-6.5-1zm-11.4-14.7c-1.6 1-1.6 3.6 0 5.9 1.6 2.3 4.3 3.3 5.6 2.3 1.6-1.3 1.6-3.9 0-6.2-1.4-2.3-4-3.3-5.6-2z"/></svg>
							Github
						</a>
					</li>
					<li>
						<a href="https://stackoverflow.com/users/1377002/andy">
							<svg class="${s.icon}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="22" height="22"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M290.7 311L95 269.7 86.8 309l195.7 41zm51-87L188.2 95.7l-25.5 30.8 153.5 128.3zm-31.2 39.7L129.2 179l-16.7 36.5L293.7 300zM262 32l-32 24 119.3 160.3 32-24zm20.5 328h-200v39.7h200zm39.7 80H42.7V320h-40v160h359.5V320h-40z"/></svg>
							Stack overflow
						</a>
					</li>
					<li>
						<a rel="me" href="https://fosstodon.org/@woodsbythesea">
							<svg class="${s.icon}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="22" height="22"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M433 179.11c0-97.2-63.71-125.7-63.71-125.7-62.52-28.7-228.56-28.4-290.48 0 0 0-63.72 28.5-63.72 125.7 0 115.7-6.6 259.4 105.63 289.1 40.51 10.7 75.32 13 103.33 11.4 50.81-2.8 79.32-18.1 79.32-18.1l-1.7-36.9s-36.31 11.4-77.12 10.1c-40.41-1.4-83-4.4-89.63-54a102.54 102.54 0 0 1-.9-13.9c85.63 20.9 158.65 9.1 178.75 6.7 56.12-6.7 105-41.3 111.23-72.9 9.8-49.8 9-121.5 9-121.5zm-75.12 125.2h-46.63v-114.2c0-49.7-64-51.6-64 6.9v62.5h-46.33V197c0-58.5-64-56.6-64-6.9v114.2H90.19c0-122.1-5.2-147.9 18.41-175 25.9-28.9 79.82-30.8 103.83 6.1l11.6 19.5 11.6-19.5c24.11-37.1 78.12-34.8 103.83-6.1 23.71 27.3 18.4 53 18.4 175z"/></svg>
							Mastodon
						</a>
					</li>
					<li>
						<a rel="me" href="/assets/journal.rss">
							<svg class="${s.icon}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="22" height="22"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zM96 136c0-13.3 10.7-24 24-24c137 0 248 111 248 248c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-110.5-89.5-200-200-200c-13.3 0-24-10.7-24-24zm0 96c0-13.3 10.7-24 24-24c83.9 0 152 68.1 152 152c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-57.4-46.6-104-104-104c-13.3 0-24-10.7-24-24zm0 120a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z"/></svg>
							RSS feed
						</a>
					</li>
				</ul>
