(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(t){if(t.ep)return;t.ep=!0;const o=n(t);fetch(t.href,o)}})();const p="_blockquote_uhtwo_1",u={blockquote:p};function g(e){return`
	...
	`}const y="_heading_1lr2x_1",w="_h1_1lr2x_7 _heading_1lr2x_1",f="_h2_1lr2x_13 _heading_1lr2x_1",b="_h3_1lr2x_26 _heading_1lr2x_1",k="_date_1lr2x_33 _h3_1lr2x_26 _heading_1lr2x_1",v={heading:y,h1:w,h2:f,h3:b,date:k};function d(e){const{link:a,level:n,type:i=e.level,text:t}=e;return`
		<${n}
			class="${v[i]}"
			${a?`id="${a}"`:""}
		>${t}
	...
	`}const $="_paragraph_1axdu_1",D={paragraph:$};function R(e){return`
		<p class="${D.paragraph}">
			${e}
		</p>
	`}const B="_table_1woq6_1",z={table:B};function M(e){return`
		<table class="${z.table}">
			${e}
		</table>
	`}function A(e){switch(e.type){case"h3":return d({level:"h3",type:"h3",text:e.text});case"blockquote":return g(e.html);case"image":return _({src:e.src,alt:e.alt});case"table":return M(e.html);case"list":return C({variant:e.variant,items:e.items});default:return R(e.html)}}function L(e){return`${A(e)}`}const j="_content_101gy_1",q={content:j};function N(e){return`
		<div class="${q.content}">
			${e.map(L).join("")}
		</div>
